                        ...
                        <div class="col-md-3">
                            ...
                            <div class="box box-primary">
                                <div class="box-body box-profile">
                                    ...
                                    <!-- Modal -->
                                    <h3 class="profile-username text-center" > {{Auth::guard('employee')->user()->name}}
                                    </h3>
                                    <p class="text-muted text-center"><i class="fa fa-address-card" aria-hidden="true"></i> {{Auth::guard('employee')->user()->email}}</p>
                                </div>
                            </div>
                        </div>
                        <!-- /.col -->
                            ...
                            <div class="nav-tabs-custom">
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane active" id="settings">
                                        <form id="myform" class="form-horizontal" action="{{url('/employee/profile/password')}}" method="post">
